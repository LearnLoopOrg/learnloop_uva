    ...
    def fetch_info(self):
        ...
        # Als geen `user_doc` is gevonden, maar de username al wel is ingesteld
            ...
            print(
                ...
                st.session_state.user_doc["username"],
            )
