...
class Recorder:
    def __init__(self, container_name_video, blob_name_video, container_name_audio, blob_name_audio):
        self.container_name_video = container_name_video
        self.blob_name_video = blob_name_video
        self.container_name_audio = container_name_audio
        self.blob_name_audio = blob_name_audio
        self.utils = Utils()
